 ...
 * @since 1.4.0
 */
public class OBDGenericBindingProvider extends
	...
	public void processBindingConfiguration(String context, Item item,
		...
		ObdBindingConfig config = new ObdBindingConfig();
	...
	class ObdBindingConfig implements BindingConfig {
		...
		public String toString() {
			return "ObdBindingConfigElement ["
					+ "variable=" + variable 
