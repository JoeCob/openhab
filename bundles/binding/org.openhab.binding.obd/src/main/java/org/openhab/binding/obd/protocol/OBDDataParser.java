...
import org.openhab.binding.obd.protocol.OBDParserRule.DataType;
...
public class OBDDataParser {
	...
	private HashMap<String, OBDParserRule> parsingRules = null;

	public OBDDataParser(
			HashMap<String, OBDParserRule> parsingRules) {
	...
	public HashMap<String, Number> parseData(byte[] data) {
		...
		for (Entry<String, OBDParserRule> entry : parsingRules
				.entrySet()) {

			OBDParserRule rule = entry.getValue();
	...
	public HashMap<String, Number> parseData(OBDObject data ) {
